...
This doocument provides examples for all expected or seen model and loading scenarios. Please note, that some of the syntax is only announced
...
"fields": [
		    {	"field_name": "OFFERING_ID",
				"field_type": "integer",
				"is_partitioning":true,"targets": [{"table_name": "offering_hub"}]},
		    {	"field_name": "CUSTOMER_ID",
				"field_type": "integer",
				"targets": [{"table_name": "customer_hub"}]
			},
