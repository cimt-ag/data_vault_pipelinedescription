...
COMMENT ON FUNCTION libdwh.dvf_decrypt(varchar,varchar) IS 'Decrypts data, that was encrypted with the data vault GDPR concept AES128-ECB. Arguments: (cipher,key) both encoded in base64 as varchar';
