...
select lt.table_name leaf_table_name, lt.satellite_parent_table businesskey_table_name,mc.column_name 
...
union 
select lt.table_name leaf_table_name, mc.table_name businesskey_table_name,mc.column_name 
from leaf_targets lt
...
-- select * from dv_pipeline_description.DVPD_DV_MODEL_PARENT_BUSINESS_KEY_COLUMN;										
