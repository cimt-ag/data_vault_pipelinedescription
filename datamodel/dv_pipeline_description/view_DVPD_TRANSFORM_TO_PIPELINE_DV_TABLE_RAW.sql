--drop view if exists dv_pipeline_description.XENC_TRANSFORM_TO_PIPELINE_DV_TABLE_RAW cascade;
create or replace view dv_pipeline_description.XENC_TRANSFORM_TO_PIPELINE_DV_TABLE_RAW as 
...
, json_array_elements(tables)->>'xenc_encryption_key_table_name' as xenc_encryption_key_table_name
