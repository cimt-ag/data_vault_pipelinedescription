...
-- drop view if exists dv_pipeline_description.DVPD_PIPELINE_PROCESS_PLAN_CVIEW cascade;
-- drop table if exists dv_pipeline_description.DVPD_PIPELINE_PROCESS_PLAN cascade;

create or replace view dv_pipeline_description.DVPD_PIPELINE_PROCESS_PLAN_CVIEW as 
...
create or replace table dv_pipeline_description.DVPD_PIPELINE_PROCESS_PLAN 
 as select * from dv_pipeline_description.DVPD_PIPELINE_PROCESS_PLAN_CVIEW;

comment on table dv_pipeline_description.DVPD_PIPELINE_PROCESS_PLAN is
