...
('xenc_test62_fgs1_enc_on_hub','{
	...
	"data_vault_model": [
		{"schema_name": "rvlt_test_jj", 
		 "tables": [
				{"table_name": "rxecd_62_aaa_hub",		"stereotype": "hub","hub_key_column_name": "HK_rxecd_62_aaa"}
				,{"table_name": "rxecd_62_aaa_p1_sat",	"stereotype": "sat","satellite_parent_table": "rxecd_62_aaa_hub"
																			,"diff_hash_column_name": "RH_rxecd_62_aaa_p1_sat"}
				]
		}
		,{"schema_name": "rvlt_xenc_keys", 
		 "tables": [
				{"table_name": "rxeck_62_aaa_hub_ek",	"stereotype": "xenc_hub-ek", "xenc_content_table_name":"rxecd_62_aaa_hub"}
				]
		}
	]
}
