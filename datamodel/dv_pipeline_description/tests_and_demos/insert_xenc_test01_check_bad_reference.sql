	...
	"data_vault_model": [
		{"schema_name": "rvlt_xenc_data", 
		 "tables": [
				...
				,{"table_name": "rxecd_01_aaa_sat",		"stereotype": "sat","satellite_parent_table": "rxecd_01_aaa_hub","diff_hash_column_name": "RH_rxecd_01_aaa_sat"}
				]
		}
		,{"schema_name": "rvlt_xenc_keys", 
		 "tables": [
				{"table_name": "rxeck_01_aaa_sat_ek",	"stereotype": "xenc_sat-ek", "xenc_content_table_name":"rxecd_xxxnot_existingxxx"}
				]
		}
	]
}
