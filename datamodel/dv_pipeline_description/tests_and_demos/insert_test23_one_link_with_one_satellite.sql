...
('test23_one_link_with_one_satellite','{
	...
	"fields": [
			  ...
			  ,{"field_name": "F5__FIELD_NAME",	"technical_type": "VARCHAR(200)",	"targets": [{"table_name": "rtjj_23_aaa_bbb_sat",
...
('test23_one_link_with_one_satellite','{
  ...
  "process_column_mapping": [
         ["rtjj_23_aaa_bbb_lnk","_A_","LK_RTJJ_23_AAA_BBB","LK_RTJJ_23_AAA_BBB",null],
         ["rtjj_23_aaa_bbb_lnk","_A_","HK_RTJJ_23_AAA","HK_RTJJ_23_AAA",null],
         ["rtjj_23_aaa_bbb_lnk","_A_","HK_RTJJ_23_BBB","HK_RTJJ_23_BBB",null],
         ["rtjj_23_aaa_bbb_sat","_A_","LK_RTJJ_23_AAA_BBB","LK_RTJJ_23_AAA_BBB",null],
         ["rtjj_23_aaa_bbb_sat","_A_","RH_RTJJ_23_AAA_BBB_SAT","RH_RTJJ_23_AAA_BBB_SAT",null],
         ["rtjj_23_aaa_bbb_sat","_A_","F3_AAA_SP1_VARCHAR","F3_AAA_SP1_VARCHAR","F3_AAA_SP1_VARCHAR"],
         ["rtjj_23_aaa_bbb_sat","_A_","F4_AAA_SP1_DECIMAL","F4_AAA_SP1_DECIMAL","F4_AAA_SP1_DECIMAL"],
         ["rtjj_23_aaa_bbb_sat","_A_","F5_AAA_SP1_VARCHAR","F5__FIELD_NAME","F5__FIELD_NAME"],
         ["rtjj_23_aaa_hub","_A_","HK_RTJJ_23_AAA","HK_RTJJ_23_AAA",null],
         ["rtjj_23_aaa_hub","_A_","F1_BK_AAA_VARCHAR","F1_BK_AAA_VARCHAR","F1_BK_AAA_VARCHAR"],
         ["rtjj_23_bbb_hub","_A_","HK_RTJJ_23_BBB","HK_RTJJ_23_BBB",null],
         ["rtjj_23_bbb_hub","_A_","F2_BK_BBB_DECIMAL","F2_BK_BBB_DECIMAL","F2_BK_BBB_DECIMAL"]
 ],
"stage_table_column": [
 ...
 "stage_hash_input_field": [
         ["_A_","HK_RTJJ_23_AAA","F1_BK_AAA_VARCHAR",0,0],
         ["_A_","HK_RTJJ_23_BBB","F2_BK_BBB_DECIMAL",0,0],
         ["_A_","LK_RTJJ_23_AAA_BBB","F1_BK_AAA_VARCHAR",0,0],
         ["_A_","LK_RTJJ_23_AAA_BBB","F2_BK_BBB_DECIMAL",0,0],
         ["_A_","RH_RTJJ_23_AAA_BBB_SAT","F3_AAA_SP1_VARCHAR",0,0],
         ["_A_","RH_RTJJ_23_AAA_BBB_SAT","F4_AAA_SP1_DECIMAL",0,0],
         ["_A_","RH_RTJJ_23_AAA_BBB_SAT","F5__FIELD_NAME",0,0]
  ]    }');                                                                                                             
