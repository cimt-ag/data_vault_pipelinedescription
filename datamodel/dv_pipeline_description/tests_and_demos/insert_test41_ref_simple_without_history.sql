...
('test41_ref_simple_without_history','{
	"dv_model_column": [
				["rtjj_41_aaa_ref",8,"content","F1_AAA_VARCHAR","VARCHAR(20)"],                      
				["rtjj_41_aaa_ref",8,"content","F2_BBB_DECIMAL","DECIMAL(20,0)"],                    
				["rtjj_41_aaa_ref",8,"content","F3_CCC_DATE","DATE"],                                
				["rtjj_41_aaa_ref",8,"content_untracked","F4_DDD_NOT_IN_RH__DECIMAL","DECIMAL(5,0)"]
],
 "stage_table_column": [
