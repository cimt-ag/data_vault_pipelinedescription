	...
	"data_vault_model": [
		{"schema_name": "rvlt_xenc_data", 
		 "tables": [
				...
				,{"table_name": "rxecd_24_aaa_sat",		"table_stereotype": "sat","satellite_parent_table": "rxecd_24_aaa_hub", "compare_criteria":"key","is_enddated":false,"has_deletion_flag":false}
				]
		}
		,{"schema_name": "rvlt_xenc_keys", 
		 "tables": [
				{"table_name": "rxeck_24_aaa_sat_ek",	"table_stereotype": "xenc_sat-ek", "xenc_content_table_name":"rxecd_24_aaa_sat"
																			, "compare_criteria":"key", "is_enddated":false,"has_deletion_flag":false}
				]
		}
	]
}
