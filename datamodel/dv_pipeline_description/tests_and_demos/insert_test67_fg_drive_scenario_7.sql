...
('test67_fg_drive_scenario_7','{
 ...
 "process_column_mapping": [
         ["rtjj_67_aaa_bbb_g1_esat","_FG1","LK_RTJJ_67_AAA_BBB","LK_RTJJ_67_AAA_BBB_FG1",null],
         ["rtjj_67_aaa_bbb_g2_esat","_FG2","LK_RTJJ_67_AAA_BBB","LK_RTJJ_67_AAA_BBB_FG2",null],
         ["rtjj_67_aaa_bbb_lnk","_FG1","LK_RTJJ_67_AAA_BBB","LK_RTJJ_67_AAA_BBB_FG1",null],
         ["rtjj_67_aaa_bbb_lnk","_FG1","HK_RTJJ_67_AAA","HK_RTJJ_67_AAA_FG1",null],
         ["rtjj_67_aaa_bbb_lnk","_FG1","HK_RTJJ_67_BBB","HK_RTJJ_67_BBB",null],
         ["rtjj_67_aaa_bbb_lnk","_FG2","LK_RTJJ_67_AAA_BBB","LK_RTJJ_67_AAA_BBB_FG2",null],
         ["rtjj_67_aaa_bbb_lnk","_FG2","HK_RTJJ_67_AAA","HK_RTJJ_67_AAA_FG2",null],
         ["rtjj_67_aaa_bbb_lnk","_FG2","HK_RTJJ_67_BBB","HK_RTJJ_67_BBB",null],
         ["rtjj_67_aaa_hub","_FG1","HK_RTJJ_67_AAA","HK_RTJJ_67_AAA_FG1",null],
         ["rtjj_67_aaa_hub","_FG1","BK_AAA","F1_BK_AAA_L1","F1_BK_AAA_L1"],
         ["rtjj_67_aaa_hub","_FG2","HK_RTJJ_67_AAA","HK_RTJJ_67_AAA_FG2",null],
         ["rtjj_67_aaa_hub","_FG2","BK_AAA","F2_BK_AAA_L2","F2_BK_AAA_L2"],
         ["rtjj_67_bbb_hub","_A_","HK_RTJJ_67_BBB","HK_RTJJ_67_BBB",null],
         ["rtjj_67_bbb_hub","_A_","F3_BK_BBB","F3_BK_BBB","F3_BK_BBB"]
 ],
 "stage_table_column": [
         ["HK_RTJJ_67_AAA_FG1","CHAR(28)",2,null,null,false],
         ["HK_RTJJ_67_AAA_FG2","CHAR(28)",2,null,null,false],
         ["HK_RTJJ_67_BBB","CHAR(28)",2,null,null,false],
         ["LK_RTJJ_67_AAA_BBB_FG1","CHAR(28)",2,null,null,false],
         ["LK_RTJJ_67_AAA_BBB_FG2","CHAR(28)",2,null,null,false],
 ...
 "stage_hash_input_field": [
         ...
         ["_FG1","HK_RTJJ_67_AAA_FG1","F1_BK_AAA_L1",0,0],
         ["_FG1","LK_RTJJ_67_AAA_BBB_FG1","F1_BK_AAA_L1",0,0],
         ["_FG1","LK_RTJJ_67_AAA_BBB_FG1","F3_BK_BBB",0,0],
         ["_FG2","HK_RTJJ_67_AAA_FG2","F2_BK_AAA_L2",0,0],
         ["_FG2","LK_RTJJ_67_AAA_BBB_FG2","F2_BK_AAA_L2",0,0],
         ["_FG2","LK_RTJJ_67_AAA_BBB_FG2","F3_BK_BBB",0,0]
  ]    }');