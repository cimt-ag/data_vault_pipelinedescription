...
('test00_check_stereotype_and_parameters','{
	...
	"fields": [
		      ...
		      , {"field_name": "F6_DC_FFF_GGG_XXX_DLINK_VARCHAR", 		"technical_type": "Varchar(20)",	"targets": [{"table_name": "rtjj_00_FFF_GGG_XXX_DLINK_WIHTOUT_LINK_KEY_COLUMN"}]}
		      , {"field_name": "F7_DC_FFF_GGG_XXX_DLINK_VARCHAR", 		"technical_type": "Varchar(20)",	"targets": [{"table_name": "rtjj_00_FFF_GGG_XXX_DLINK_WIHTOUT_LINK_KEY_COLUMN"}]}
			 ],
	"data_vault_model": [
		{"schema_name": "rvlt_test_jj", 
		 "tables": [
			...
			,	{"table_name": "rtjj_00_DDD_EEE_XXX_LINK_WIHTOUT_PARENT_DECLARATION", "stereotype": "lnk","link_key_column_name": "LK_rtjj_00_DDD_EEE_XXX_LINK_WIHTOUT_PARENT_DECLARATION"}
			...
			,	{"table_name": "rtjj_00_FFF_GGG_XXX_LINK_WIHTOUT_LINK_KEY_COLUMN", "stereotype": "lnk","link_parent_tables":["rtjj_00_FFF_HUB","rtjj_00_GGG_HUB"]}
			,	{"table_name": "rtjj_00_FFF_GGG_XXX_DLINK_WIHTOUT_LINK_KEY_COLUMN", "stereotype": "lnk","link_parent_tables":["rtjj_00_FFF_HUB","rtjj_00_GGG_HUB"]}
			,	{"table_name": "rtjj_00_FFF_GGG", "stereotype": "lnk","link_key_column_name": "LK_rtjj_00_FFF_GGG","link_parent_tables":["rtjj_00_FFF_HUB","rtjj_00_GGG_HUB"]}
