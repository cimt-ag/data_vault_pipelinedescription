...
('test28_transactional_link_with_non_historized_satellite','{
	...
	"fields": [
		      {"field_name": "F1_BK_AAA_VARCHAR", 	"field_type": "Varchar(20)",	"targets": [{"table_name": "rtjj_28_aaa_hub"}]}
		 	  ...
		 	  ,{"field_name": "F3_AAA_SP1_VARCHAR",	"field_type": "VARCHAR(200)",	"targets": [{"table_name": "rtjj_28_aaa_bbb_tlsat"}]}
			  ,{"field_name": "F4_AAA_SP1_DECIMAL",	"field_type": "DECIMAL(5,0)",	"targets": [{"table_name": "rtjj_28_aaa_bbb_tlsat"}]}
			  ,{"field_name": "F5__FIELD_NAME",	"field_type": "VARCHAR(200)",	"targets": [{"table_name": "rtjj_28_aaa_bbb_tlsat",
...
('test28_transactional_link_with_non_historized_satellite','{
 "dv_model_column": [
      ["rvlt_test_jj","rtjj_28_aaa_bbb_tlnk",1,"meta","META_INSERTED_AT","TIMESTAMP"],
      ["rvlt_test_jj","rtjj_28_aaa_bbb_tlnk",1,"meta","META_JOB_INSTANCE_ID","INT8"],
      ["rvlt_test_jj","rtjj_28_aaa_bbb_tlnk",1,"meta","META_RECORD_SOURCE","VARCHAR(255)"],
      ["rvlt_test_jj","rtjj_28_aaa_bbb_tlnk",2,"key","LK_RTJJ_28_AAA_BBB","CHAR(28)"],
      ["rvlt_test_jj","rtjj_28_aaa_bbb_tlnk",3,"parent_key","HK_RTJJ_28_AAA","CHAR(28)"],
      ["rvlt_test_jj","rtjj_28_aaa_bbb_tlnk",3,"parent_key","HK_RTJJ_28_BBB","CHAR(28)"],
      ["rvlt_test_jj","rtjj_28_aaa_bbb_tlsat",1,"meta","META_INSERTED_AT","TIMESTAMP"],
      ["rvlt_test_jj","rtjj_28_aaa_bbb_tlsat",1,"meta","META_JOB_INSTANCE_ID","INT8"],
      ["rvlt_test_jj","rtjj_28_aaa_bbb_tlsat",1,"meta","META_RECORD_SOURCE","VARCHAR(255)"],
      ["rvlt_test_jj","rtjj_28_aaa_bbb_tlsat",2,"parent_key","LK_RTJJ_28_AAA_BBB","CHAR(28)"],
      ["rvlt_test_jj","rtjj_28_aaa_bbb_tlsat",8,"content","F3_AAA_SP1_VARCHAR","VARCHAR(200)"],
      ["rvlt_test_jj","rtjj_28_aaa_bbb_tlsat",8,"content","F4_AAA_SP1_DECIMAL","DECIMAL(5,0)"],
      ["rvlt_test_jj","rtjj_28_aaa_bbb_tlsat",8,"content","F5_AAA_SP1_VARCHAR","VARCHAR(200)"],
 ...
 "process_column_mapping": [
         ["rtjj_28_aaa_bbb_tlnk","_A_","LK_RTJJ_28_AAA_BBB","LK_RTJJ_28_AAA_BBB",null],
         ["rtjj_28_aaa_bbb_tlnk","_A_","HK_RTJJ_28_AAA","HK_RTJJ_28_AAA",null],
         ["rtjj_28_aaa_bbb_tlnk","_A_","HK_RTJJ_28_BBB","HK_RTJJ_28_BBB",null],
         ["rtjj_28_aaa_bbb_tlsat","_A_","LK_RTJJ_28_AAA_BBB","LK_RTJJ_28_AAA_BBB",null],
         ["rtjj_28_aaa_bbb_tlsat","_A_","F3_AAA_SP1_VARCHAR","F3_AAA_SP1_VARCHAR","F3_AAA_SP1_VARCHAR"],
         ["rtjj_28_aaa_bbb_tlsat","_A_","F4_AAA_SP1_DECIMAL","F4_AAA_SP1_DECIMAL","F4_AAA_SP1_DECIMAL"],
         ["rtjj_28_aaa_bbb_tlsat","_A_","F5_AAA_SP1_VARCHAR","F5__FIELD_NAME","F5__FIELD_NAME"],
